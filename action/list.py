...
from constants.action_constants import (
    GENERAL_USER_ID, ADMIN_USER_TYPE, PUBLIC_LIST_TYPE, DICTIONARY_TYPE,
    OBJECT_TYPE, VIETNAMESE_LANGUAGE_TYPE
)
...
class ListAction:
    ...
    def get_list_by_id(user_id, list_id, return_type=DICTIONARY_TYPE):
        ...
        if not user_id:
            list_entity = List.query.filter_by(list_id=list_id, list_type=PUBLIC_LIST_TYPE).first()
